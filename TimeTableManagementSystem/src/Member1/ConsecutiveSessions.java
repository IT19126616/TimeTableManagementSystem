...
public class ConsecutiveSessions {
	...
	private void initialize() {
		...
		panel_3_1_1.setBounds(274, 571, 1060, 211);
		frmAddStudentGroups.getContentPane().add(panel_3_1_1);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 22, 1029, 90);
		panel_3_1_1.add(scrollPane);
		
		JTextPane textPane = new JTextPane();
		textPane.setFont(new Font("Trebuchet MS", Font.BOLD, 16));
		...
		btnMakeSession.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				textPane.setText("Consecutive Session:("+comboBox.getSelectedItem().toString()+")+("+comboBox_1.getSelectedItem().toString()+")");
		...
		btnMakeSession.setBounds(447, 142, 195, 34);
