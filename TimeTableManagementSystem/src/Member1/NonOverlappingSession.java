...
public class NonOverlappingSession {
	...
	private void initialize() {
		...
		panel_3_1_1.setBounds(274, 531, 1058, 197);
		...
		btnMakeSession.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textPane.setText("Non-Overlapping Session:("+comboBox.getSelectedItem().toString()+")");
			}
		});
		...
		btnMakeSession.setBounds(450, 137, 195, 34);
		panel_3_1_1.add(btnMakeSession);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 22, 1029, 104);
