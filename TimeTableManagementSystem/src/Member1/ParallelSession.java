...
public class ParallelSession {
	...
	private void initialize() {
		...
		frmAddStudentGroups.setTitle("Make Parallel Sessions");
		...
		JLabel lblNewLabel_1 = new JLabel("Make Parallel Sessions");
		...
		panel_3.setBounds(274, 193, 1058, 241);
		...
		JLabel lblNewLabel_2_1_1 = new JLabel("Select Lecture");
		...
		panel_3_1_1.setBounds(274, 526, 1058, 190);
		...
		btnMakeSession.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textPane.setText("Parallel Session:("+comboBox.getSelectedItem().toString()+")+("+comboBox_1.getSelectedItem().toString()+")");
			}
		});
		...
		btnMakeSession.setBounds(450, 132, 195, 34);
		panel_3_1_1.add(btnMakeSession);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 31, 1029, 90);
		...
		btnManageGroups_2_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String session= textPane.getText();
				 ...
				 try {
					 Connection con = DBConnect.connect();
	                    ...
	                    String query = "INSERT INTO parallel values(null,null,null, '" + session + "')";
		...
		separator.setBounds(272, 137, 1082, 18);
