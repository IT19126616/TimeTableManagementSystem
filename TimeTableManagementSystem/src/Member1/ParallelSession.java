...
public class ParallelSession {
	...
	private void initialize() {
		...
		panel_3.setBounds(274, 193, 1070, 241);
		...
		panel_3_1_1.setBounds(274, 526, 1070, 154);
		...
		textField.setBounds(12, 38, 1046, 34);
		...
		btnMakeSession.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				textField.setText("Parallel Session:("+comboBox.getSelectedItem().toString()+")+("+comboBox_1.getSelectedItem().toString()+")");
			}
		});
