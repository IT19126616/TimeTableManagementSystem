...
public class Rooms_TimeTable {
	...
	public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Rooms_TimeTable window = new Rooms_TimeTable();
	...
	public void fillComboBox() {
		try {
			...
			String query="select DISTINCT from lecturers";
			PreparedStatement pst=con.prepareStatement(query);
			ResultSet rs=pst.executeQuery();
			//comboBox.setModel(DbUtils.resultSetToNestedList(rs));
			//comboBox.setModel(new DefaultComboBoxModel(new String[] {"Select Lecturer..."}))
	...
	public void fillComboBox5() {
		try {
			...
			String query="select DISTINCT room from timeAlloLecture ";
			PreparedStatement pst=con.prepareStatement(query);
			ResultSet rs=pst.executeQuery();
			//comboBox.setModel(DbUtils.resultSetToNestedList(rs));
			//comboBox.setModel(new DefaultComboBoxModel(new String[] {"Select Lecturer..."}))
			while(rs.next()) {
				String lecturename=rs.getString("room");
	...
	private void initialize() {
		...
		JButton btnManageGroups = new JButton("Table for Students");
		...
		btnManageGroups.setBounds(12, 456, 240, 50);
		...
		btnViewGroups_1.setBounds(12, 698, 238, 50);
		...
		JButton btnTableForRooms = new JButton("Table for Rooms");
		btnTableForRooms.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		btnTableForRooms.setForeground(new Color(21, 25, 28));
		btnTableForRooms.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		btnTableForRooms.setBackground(new Color(152, 201, 45));
		btnTableForRooms.setBounds(12, 387, 250, 50);
		panel_1.add(btnTableForRooms);
		
		JLabel lblNewLabel_1 = new JLabel("Time Table for Locations");
		...
		panel_3.setBounds(263, 736, 1098, 124);
		panel_3.setBackground(new Color(0, 0, 0));
		frmAddNotAvailbleTime.getContentPane().add(panel_3);
		panel_3.setLayout(null);
		
		JButton button = new JButton("Print Timetable");
		...
		button.setForeground(new Color(21, 25, 28));
		button.setFont(new Font("Trebuchet MS", Font.BOLD, 19));
		button.setBackground(new Color(152, 201, 45));
		button.setBounds(438, 42, 295, 50);
		panel_3.add(button);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(272, 242, 1062, 441);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String query="select day,startTime,endTime,sessionSign from timeAlloLecture where room='"+comboBox.getSelectedItem()+"' order by day,startTime,endTime";
					PreparedStatement pst=con.prepareStatement(query);
					ResultSet rs=pst.executeQuery();
					table.setModel(DbUtils.resultSetToTableModel(rs));
