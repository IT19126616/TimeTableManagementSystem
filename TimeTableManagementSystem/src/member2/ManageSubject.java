...
public class ManageSubject {
	...
	private void initialize() {
        ...
        int h = d.height;
        int w = d.width;
        frameManageLocation.setSize( w , h );
		...
		panel_1.setBounds(0, 71, 262, 668);
		...
		btnViewGroups_1.setBounds(12, 543, 238, 50);
		...
		panel_3.setBounds(272, 443, 1082, 296);
		...
		txtMLBuildingName.setFont(new Font("Trebuchet MS", Font.BOLD, 16));		
		...
		btnDelete.setBounds(1185, 239, 139, 50);
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				 ...
				 String Semester=null;
					    ...
					    if(txtMLBuildingName.getText().equals("")||textField.getText().equals("")||textField_1.getText().equals("")) {
							
							JOptionPane.showMessageDialog(null, "Please Fill the Text Boxes Values First!");
						}
		                	...
		                	try {
		    					...
		    					if (rdbtnNewRadioButton.isSelected()) { 
		    	                	...
		    	                	JOptionPane.showMessageDialog(panel, "Please select a Semester", "Warning",JOptionPane.WARNING_MESSAGE);
		    	                }
		...
		btnUpdate.setBounds(1185, 178, 139, 50);
		...
		*/
		...
		btnClear.setBounds(1185, 300, 139, 50);
		frameManageLocation.getContentPane().add(btnClear);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(272, 164, 903, 267);
