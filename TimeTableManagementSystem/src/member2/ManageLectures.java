...
public class ManageLectures {
	...
	private void initialize() {
		...
		frmAddStudentGroups.addWindowListener(new WindowAdapter() {
			...
			public void windowActivated(WindowEvent arg0) {
				try {
					...
					columnModel.getColumn(9).setPreferredWidth(5);
		...
		frmAddStudentGroups.setTitle("Manage Lecture Groups");
		...
		panel_1.setBounds(0, 78, 262, 661);
		...
		*/
		...
		panel_3.setBounds(272, 462, 1072, 277);
		...
		panel_3.add(facultyNames);
		 ...
		 depname.setModel(new DefaultComboBoxModel(new String[] {"Select Department", "Department of Information Technology", "Department of Computer Systems Engineering", "Department of  Software Engineering", "Department of Business IT ", "Select Department", "Department of Information Technology", "Department of Computer Systems Engineering", "Department of Computer Science & Software Engineering", "Department of Business IT "}));
		...
		panel_3.add(center);
		 ...
		 building.setModel(new DefaultComboBoxModel(new String[] {"Select A Building", "D-Block", "Main Building"}));
				...
				if(Level.getSelectedItem().toString().equals("Select Level") ) {
					...
					if(textField_1.getText().equals("")) {
						...
						try {
							...
							int cap =Integer.parseInt(textField_1.getText().toString());
		...
		lblNewLabel_2_1_3_2_1.setForeground(Color.BLACK);
...
if(textField.getText().equals("")||textField_1.getText().equals("")||textField_2.getText().equals("")||textField_5.getText().equals("")) {
		...
		btnDelete.setBounds(1183, 226, 139, 50);
		...
		btnClear.setBounds(1183, 287, 139, 50);
		...
		*/
		...
		btnViewGroups_1.setBounds(14, 550, 238, 50);
		btnViewGroups_1.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		panel_1.add(btnViewGroups_1);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(272, 164, 905, 287);
