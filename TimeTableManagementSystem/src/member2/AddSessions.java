...
public class AddSessions {
	...
	/*public void fillComboBox() {
		try {
			...
			String query="select * from studentGroups where groupID='"+comboBox_4.getSelectedItem()+"'";
	...
	private void initialize() {
		...
		btnManageGroups.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ManageSessions itm = new ManageSessions();
				try {
		...
		btnManageGroups.setBounds(14, 407, 238, 50);
		...
		btnViewGroups_1.setBounds(12, 551, 238, 50);
		...
		lblNewLabel_1.setBounds(262, 93, 846, 48);
		...
		panel_3.setBounds(262, 623, 1082, 74);
		...
		btnSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				String SubjectCode=(String) comboBox_3.getText();
...
if(textField.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(null, "Please Fill Session Signature");
				}else {
				...
				try {
					 ...
					 Connection con = DBConnect.connect();
	                    ...
	                    String query = "INSERT INTO session values(null, '" + Lec1 + "','" + Lec2 + "','" + SubjectCode + "','" +
	                    		SubjectName + "','" + SubGrp + "','"+ Tag +"','"+ NoOfStudents +"','"+ Duration +"','"+ SessionSignature +"')";
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBox.getSelectedItem().toString().equals("Select Lecturer 1") ) {
					...
					JOptionPane.showMessageDialog(null, "Please Select The Lecturer 2");
						...
						}else if(comboBox_3.getText().toString().equals("Select Subject Code") ) {
							JOptionPane.showMessageDialog(null, "Please Select The Subject Code");
							
							}else if(comboBox_5.getSelectedItem().toString().equals("Select Sub Group") ) {
									JOptionPane.showMessageDialog(null, "Please Select The Sub Group");
									
									}else if(comboBox_4_1.getSelectedItem().toString().equals("Select Tag") ) {
								...
								try {
									...
									textField.setText(comboBox.getSelectedItem().toString()+"(Lec1) - "+comboBox_2.getSelectedItem().toString()+"(Lec2) - "+comboBox_1.getSelectedItem().toString()+" - "+comboBox_3.getText().toString()+" - (Group)"+comboBox_5.getSelectedItem().toString()+" - "+comboBox_4_1.getSelectedItem().toString()+" - "+spinner_1.getValue().toString()+"(Students) - "+spinner.getValue().toString()+"Hrs");
		...
		comboBox_3.setBounds(995, 619, 262, 38);
		...
		spinner_1.setBorder(new LineBorder(new Color(169, 224, 49), 3));
		 ...
		 comboBox_5.setFont(new Font("Trebuchet MS", Font.BOLD, 16));
		...
		lblSelectDay_1.setForeground(new Color(169, 224, 49));
		 ...
		 comboBox_4_1.setFont(new Font("Trebuchet MS", Font.BOLD, 16));
		...
		comboBox_3.setFont(new Font("Trebuchet MS", Font.BOLD, 16));
		comboBox_3.setBounds(1072, 244, 262, 38);
		frmAddNotAvailbleTime.getContentPane().add(comboBox_3);
		comboBox_3.setBackground(new Color(51, 51, 51));
		comboBox_3.setForeground(Color.WHITE);
		comboBox_3.setBorder(new LineBorder(new Color(169, 224, 49), 3));
		comboBox_3.setColumns(10);
