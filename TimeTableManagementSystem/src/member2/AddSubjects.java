...
public class AddSubjects {
	...
	private void initialize() {
		...
		panel_1.setBounds(0, 79, 262, 665);
		...
		btnViewGroups_1.setBounds(14, 567, 238, 50);
		...
		Offeredyear.setFont(new Font("Trebuchet MS", Font.BOLD, 16));		
		...
		panel_3.setBounds(262, 637, 1082, 71);
		...
		subcode.setFont(new Font("Trebuchet MS", Font.BOLD, 16));
		...
		subjectname.setFont(new Font("Trebuchet MS", Font.BOLD, 16));
