...
////////////////////////////////////////////////////		
		...
		//LocID.setForeground(Color.BLACK);
		//LocID.setBackground(Color.BLACK);
		

		//LocID.setBorder(new LineBorder(new Color(169, 224, 49), 3));

		LocID.setBackground(Color.BLACK);
		LocID.setForeground(Color.BLACK);
		LocID.setBorder(new LineBorder(Color.BLACK, 3));
		
		//LocID.setBorder(new LineBorder(new Color(0,0,0), 3));
