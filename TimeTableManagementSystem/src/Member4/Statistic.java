...
public class Statistic {
	...
	private JButton btnViewGroups_1;
	...
	*/
	...
	public void setGroupData() {
		try {
			...
			String lastLec3 ="SELECT SubGroupID FROM studentGroups WHERE SGroupID = (SELECT MAX(SGroupID) FROM studentGroups)";
			PreparedStatement pst13 =con3.prepareStatement(lastLec3);
			ResultSet rs13 =pst13.executeQuery();
			String txtLastLec3 = rs13.getString("SubGroupID");
			textField_6.setText(txtLastLec3);
...
///////////////////////////////////////////////////////////////////////////////////////////////		
		...
		btnStats.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				// dataset.setValue(12, "Buildings", "Buildings");
				 ...
				 frame1.setBounds(350, 90, 1350, 900);
		...
		btnStats.setBackground(Color.red);
		btnStats.setForeground(new Color(255, 255, 255));
		btnStats.setFont(new Font("Trebuchet MS", Font.BOLD, 18));
	 ...
	 btnViewGroups_1 = new JButton("<<Back");
