...
public class TimeTable_location {

	private JFrame frame;	private JTable table;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TimeTable_location window = new TimeTable_location();
	...
	private void initialize() {
		...
		btnManageLocation.setBounds(12, 383, 252, 50);
